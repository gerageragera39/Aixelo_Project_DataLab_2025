...
output_CO2 = "matched_CO2_with_energy.csv"
with open(output_CO2, mode='w', newline='', encoding='utf-8') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(['file_path', 'energy'])
    writer.writerows(matching_cif_files_CO2)

output_H2O = "matched_H2O_with_energy.csv"
with open(output_H2O, mode='w', newline='', encoding='utf-8') as csvfile:
    writer = csv.writer(csvfile)
    writer.writerow(['file_path', 'energy'])
    writer.writerows(matching_cif_files_H2O)
